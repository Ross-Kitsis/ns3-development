...
GeoReplyHeader::GeoReplyHeader(Vector OriginPosition, Time OriginalTimestamp,
...
GeoReplyHeader::~GeoReplyHeader()
{
	// TODO Auto-generated destructor stub
}

TypeId
GeoReplyHeader::GetTypeId()
{
	static TypeId tid = TypeId ("ns3::thesis::GeoReplyHeader")
    		.SetParent<Header> ()
    		.SetGroupName("thesis")
    		.AddConstructor<GeoReplyHeader> ()
    		;
	return tid;
}

TypeId
GeoReplyHeader::GetInstanceTypeId() const
{
	return GetTypeId();
}

uint32_t
GeoReplyHeader::GetSerializedSize() const
{
...
void
GeoReplyHeader::Serialize(Buffer::Iterator i) const
{
...
uint32_t
GeoReplyHeader::Deserialize(Buffer::Iterator start)
{
...
void
GeoReplyHeader::Print (std::ostream &os) const
{
	os << "GeoReply Header: Original Position: " << m_OriginPosition <<
