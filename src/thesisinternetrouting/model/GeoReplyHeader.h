...
#ifndef SRC_THESISINTERNETROUTING_MODEL_GeoReplyHeader_H_
#define SRC_THESISINTERNETROUTING_MODEL_GeoReplyHeader_H_
...
class GeoReplyHeader : public Header
{
public:

	GeoReplyHeader(Vector m_OriginPosition = Vector(), Time m_OriginalTimestamp = Simulator::Now(),
...
#endif /* SRC_THESISINTERNETROUTING_MODEL_GeoReplyHeader_H_ */
