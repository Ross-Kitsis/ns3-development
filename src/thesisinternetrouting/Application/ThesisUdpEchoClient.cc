...
#include "ThesisUdpEchoClient.h"
#include "ns3/ipv6.h"


namespace ns3 {

NS_LOG_COMPONENT_DEFINE ("ThesisUdpEchoClientApplication");

NS_OBJECT_ENSURE_REGISTERED (ThesisUdpEchoClient);

TypeId
ThesisUdpEchoClient::GetTypeId (void)
{
	static TypeId tid = TypeId ("ns3::ThesisUdpEchoClient")
    		.SetParent<Application> ()
    		.SetGroupName("Applications")
    		.AddConstructor<ThesisUdpEchoClient> ()
...
ThesisUdpEchoClient::ThesisUdpEchoClient ()
{
...
void
ThesisUdpEchoClient::SetRemote (Address ip, uint16_t port)
{
...
void
ThesisUdpEchoClient::SetRemote (Ipv4Address ip, uint16_t port)
{
	NS_LOG_FUNCTION (this << ip << port);
...
void
ThesisUdpEchoClient::SetRemote (Ipv6Address ip, uint16_t port)
{
	NS_LOG_FUNCTION (this << ip << port);
	m_peerAddress = Address (ip);
	m_peerPort = port;
...
void
ThesisUdpEchoClient::StartApplication (void)
{
	NS_LOG_FUNCTION (this);
...
void
ThesisUdpEchoClient::StopApplication ()
{
	NS_LOG_FUNCTION (this);
...
void
ThesisUdpEchoClient::SetDataSize (uint32_t dataSize)
{
...
uint32_t
ThesisUdpEchoClient::GetDataSize (void) const
{
	NS_LOG_FUNCTION (this);
	return m_size;
}
...
void
ThesisUdpEchoClient::SetFill (std::string fill)
{
...
void
ThesisUdpEchoClient::SetFill (uint8_t fill, uint32_t dataSize)
{
...
void
ThesisUdpEchoClient::SetFill (uint8_t *fill, uint32_t fillSize, uint32_t dataSize)
{
...
void
ThesisUdpEchoClient::ScheduleTransmit (Time dt)
{
...
ThesisUdpEchoClient::Send (void)
{
	...
	if (m_dataSize)
	{
		...
		//
		NS_ASSERT_MSG (m_dataSize == m_size, "ThesisUdpEchoClient::Send(): m_size and m_dataSize inconsistent");
		NS_ASSERT_MSG (m_data, "ThesisUdpEchoClient::Send(): m_dataSize but no m_data");
