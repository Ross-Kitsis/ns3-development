 ...
 */
#ifndef THESIS_UDP_ECHO_HELPER_H
#define THESIS_UDP_ECHO_HELPER_H
 ...
 */
class ThesisUdpEchoServerHelper
{
public:
  /**
   ...
   */
	ThesisUdpEchoServerHelper (uint16_t port);
 ...
 */
class ThesisUdpEchoClientHelper
{
public:
  /**
   ...
   */
	ThesisUdpEchoClientHelper (Address ip, uint16_t port);
  /**
   * Create UdpEchoClientHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   ...
   * \param port The port number of the remote udp echo server
   */
	ThesisUdpEchoClientHelper (Ipv4Address ip, uint16_t port);
  /**
   * Create UdpEchoClientHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   ...
   * \param port The port number of the remote udp echo server
   */
	ThesisUdpEchoClientHelper (Ipv6Address ip, uint16_t port);
