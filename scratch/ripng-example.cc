...
int main (int argc, char** argv)
{
  ...
  NetDeviceContainer d1 = wifi.Install (wifiPhy, wifiMac, net1);
  NetDeviceContainer d2 = wifi.Install (wifiPhy, wifiMac, net2);
  //devices = wifi.Install (wifiPhy, wifiMac, all);


  NS_LOG_INFO ("Create networks and assign IPv6 Addresses.");
  Ipv6AddressHelper ipv6;
  ipv6.SetBase(Ipv6Address ("2001:1::"), 64);
  Ipv6InterfaceContainer i1 = ipv6.Assign (d1);
  i1.SetForwarding(1, true);
  ipv6.SetBase (Ipv6Address ("2001:2::"), 64);
